#ifndef __itkPolyaffineLogDomainDemonsRegistrationFilter_txx
#define __itkPolyaffineLogDomainDemonsRegistrationFilter_txx
...
namespace itk {
	...
	PolyaffineLogDomainDemonsRegistrationFilter<TFixedImage,TMovingImage,TField,TFixedMaskImage,TMovingMaskImage,TWeightImage>
	...
	template <class TFixedImage, class TMovingImage, class TField, class TFixedMaskImage, class TMovingMaskImage, class TWeightImage>
	typename PolyaffineLogDomainDemonsRegistrationFilter<TFixedImage,TMovingImage,TField,TFixedMaskImage,TMovingMaskImage,TWeightImage>
	...
	// Checks whether the DifferenceFunction is of type DemonsRegistrationFunction.
	template <class TFixedImage, class TMovingImage, class TField, class TFixedMaskImage, class TMovingMaskImage, class TWeightImage>
	const typename PolyaffineLogDomainDemonsRegistrationFilter<TFixedImage,TMovingImage,TField,TFixedMaskImage,TMovingMaskImage,TWeightImage>
	::DemonsRegistrationFunctionType*
	PolyaffineLogDomainDemonsRegistrationFilter<TFixedImage,TMovingImage,TField,TFixedMaskImage,TMovingMaskImage,TWeightImage>
	...
	::InitializeIteration()
	{
		//std::cout<<"PolyaffineLogDomainDemonsRegistrationFilter::InitializeIteration"<<std::endl;
	...
	// Get gradient type
	template <class TFixedImage, class TMovingImage, class TField, class TFixedMaskImage, class TMovingMaskImage, class TWeightImage>
	typename PolyaffineLogDomainDemonsRegistrationFilter<TFixedImage,TMovingImage,TField,TFixedMaskImage,TMovingMaskImage,TWeightImage>::GradientType
	PolyaffineLogDomainDemonsRegistrationFilter<TFixedImage,TMovingImage,TField,TFixedMaskImage,TMovingMaskImage,TWeightImage>
	...
	{
		//std::cout<<"PolyaffineLogDomainDemonsRegistrationFilter::ApplyUpdate"<<std::endl;
