...
Module:    $RCSfile: itkESMDemonsRegistrationMaskFunction.h,v $
Language:  C++
...
#ifndef __itkESMDemonsRegistrationMaskFunction_h
#define __itkESMDemonsRegistrationMaskFunction_h
...
namespace itk {
/**
 * \class ESMDemonsRegistrationMaskFunction
 *
 ...
 *
 */
template<class TFixedImage, class TMovingImage, class TDeformationField, class TFixedMaskImage, class TMovingMaskImage >
class ITK_EXPORT ESMDemonsRegistrationMaskFunction :
      public PDEDeformableRegistrationFunction< TFixedImage,
                                                TMovingImage, TDeformationField>
{
public:
  /** Standard class typedefs. */
  typedef ESMDemonsRegistrationMaskFunction               Self;
  ...
  itkTypeMacro( ESMDemonsRegistrationMaskFunction,
  ...
  virtual GradientType GetUseGradientType() const
	...
	void SetFixedMaskImage(FixedMaskImagePointer fixedMaskImage) 
	{ m_FixedMaskImage = fixedMaskImage; }
    
    void SetMovingMaskImage(MovingMaskImagePointer movingMaskImage)
    { m_MovingMaskImage = movingMaskImage; }

protected:
  ESMDemonsRegistrationMaskFunction();
  ~ESMDemonsRegistrationMaskFunction() {}
...
private:
  ESMDemonsRegistrationMaskFunction(const Self&); //purposely not implemented
  ...
  mutable double                  m_PreviousMetric;
...
#include "itkESMDemonsRegistrationMaskFunction.txx"
#endif
