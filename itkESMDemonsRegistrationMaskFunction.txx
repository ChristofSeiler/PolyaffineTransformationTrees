/*=========================================================================
  ...
  Module:    $RCSfile: itkESMDemonsRegistrationMaskFunction.txx,v $
  Language:  C++
...
#ifndef __itkESMDemonsRegistrationMaskFunction_txx
#define __itkESMDemonsRegistrationMaskFunction_txx
...
ESMDemonsRegistrationMaskFunction<TFixedImage,TMovingImage,TDeformationField,TFixedMaskImage,TMovingMaskImage>
::ESMDemonsRegistrationMaskFunction()
{
  ...
  m_PreviousMetric = NumericTraits<double>::max();
 ...
 */
template <class TFixedImage, class TMovingImage, class TDeformationField, class TFixedMaskImage, class TMovingMaskImage>
typename ESMDemonsRegistrationMaskFunction<TFixedImage,TMovingImage,TDeformationField,TFixedMaskImage,TMovingMaskImage>
::PixelType
ESMDemonsRegistrationMaskFunction<TFixedImage,TMovingImage,TDeformationField,TFixedMaskImage,TMovingMaskImage>
                ...
                const FloatOffsetType& itkNotUsed(offset))
{
  ...
  // if we could, this would be an often unnecessary time-consuming task.
	typename FixedMaskImageType::PixelType fixedMaskValue = m_FixedMaskImage->GetPixel(index);
    typename MovingMaskImageType::PixelType movingMaskValue = m_MovingMaskImage->GetPixel(index);

  if ( globalData && ( fixedMaskValue || movingMaskValue ) )
    {
