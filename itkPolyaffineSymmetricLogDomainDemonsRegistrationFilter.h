#ifndef __itkPolyaffineSymmetricLogDomainDemonsRegistrationFilter_h
#define __itkPolyaffineSymmetricLogDomainDemonsRegistrationFilter_h
...
/**
 * \class PolyaffineSymmetricLogDomainDemonsRegistrationFilter
...
class ITK_EXPORT PolyaffineSymmetricLogDomainDemonsRegistrationFilter : 
...
public:
  ...
  typedef PolyaffineSymmetricLogDomainDemonsRegistrationFilter    Self;
  ...
  itkTypeMacro( PolyaffineSymmetricLogDomainDemonsRegistrationFilter,PolyaffineLogDomainDeformableRegistrationFilter );
...
private:
  PolyaffineSymmetricLogDomainDemonsRegistrationFilter(const Self&); //purposely not implemented
...
#include "itkPolyaffineSymmetricLogDomainDemonsRegistrationFilter.txx"
#endif
